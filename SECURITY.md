...
**"wellfound-scraper security"** in the subject — otherwise it lands in a queue
...
- **Bypassing Wellfound's bot protection.** This scraper drives an ordinary
...
- **The scraper stopped working.** Wellfound changing its markup is expected —
